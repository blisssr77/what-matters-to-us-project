  ...
  return (
    <div className="sticky top-0 z-10 bg-gray-100/80 backdrop-blur border-b">
      <div className="flex items-center gap-3 px-4 py-2">
        {/* Today + nav */}
        <button onClick={onToday} className="px-3 py-1.5 rounded border bg-white hover:bg-gray-50 text-sm">Today</button>
        <div className="flex items-center">
          <button onClick={onPrev} className="p-1.5 rounded border bg-white hover:bg-gray-50"><ChevronLeft size={18} /></button>
          <button onClick={onNext} className="ml-2 p-1.5 rounded border bg-white hover:bg-gray-50"><ChevronRight size={18} /></button>
        </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search"
            className="pl-8 pr-3 py-1.5 rounded border bg-white text-sm w-52 focus:outline-none"
          />
        </div>

        {/* view switch */}
        <div className="ml-2 inline-flex rounded border bg-white overflow-hidden">
        ...
        <button className="ml-2 p-2 rounded border bg-white hover:bg-gray-50">
