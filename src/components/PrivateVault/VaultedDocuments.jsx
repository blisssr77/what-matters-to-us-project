  ...
  return (
    <Layout>
      <div className="p-6 max-w-5xl mx-auto">
        ...
        {/* Title */}
        <h2 className="text-2xl font-bold text-purple-500 mb-4">🔐 Your Vaulted Documents</h2>
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-between items-start gap-4 mb-6">
          ...
          <div className="relative w-full md:w-1/2">
            ...
            <input
              ...
              className="w-full pl-10 pr-8 py-2 border border-gray-300 rounded-lg shadow-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
        ...
        <div className="relative w-full md:w-1/2" ref={tagBoxRef}>
          <button
            ...
            className="w-full flex items-center justify-between px-4 py-2 border border-gray-300 rounded-lg text-gray-700 bg-white shadow-sm hover:border-purple-400"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {filteredDocs.map((doc) => (
          ...
          >
            ...
            {/* Show "Last Modified" only if updated_at !== created_at */}
            ...
            <div className="flex justify-between items-center mt-auto">
              {doc.file_url ? (
                <>
                  ...
                  <span className="text-xs text-red-500 font-semibold">Contains File</span>
                </>
              ) : (
                <button
                  onClick={() => navigate(`/private/vaults/note/${doc.id}`)}
                  className="text-sm bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700 transition"
                >
                  View Note
                </button>
